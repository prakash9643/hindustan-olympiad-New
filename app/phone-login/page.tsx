...
import { ChevronRight, School, User, Users } from 'lucide-react';
...
export default function PhoneLogin() {
    ...
    const sendOTP = async (e: any) => {
        ...
        try {
            ...
            if (data.error) {
                error(data.error, { duration: 3000, position: "top-right", description: "Invalid mobile number." });
            } else {
    ...
    const verifyOTP = async (e: any) => {
        ...
        try {
            ...
            if (data.error) {
                error(data.error, { duration: 3000, position: "top-right", description: "Incorrect OTP. Please try again." });
            } else {
        ...
        <div className="container flex h-screen w-full flex-col items-center justify-center px-4 mx-auto">
            ...
            <Card className='max-w-sm w-full'>
                <CardHeader className="space-y-1">
                    <CardTitle className="text-2xl font-bold">Select way to login</CardTitle>
                </CardHeader>
                    ...
                    {/* <form onSubmit={sendOTP} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Button
                                    type="submit"
                                    disabled={loading || !mobile || mobile.length !== 10 || !/^\d+$/.test(mobile)}
