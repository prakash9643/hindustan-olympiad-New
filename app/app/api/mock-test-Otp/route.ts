...
export async function POST(req: NextRequest,) {
    try {
        ...
        const data = qs.stringify({
            sender: "HNOLYM",
            content: `Your OTP is ${otp}. Prepare Smarter for Hindustan Olympiad 2025 with STEMLearn.AI App using free access to study material and mock tests`,
            apikey: apiKey,
            type: "normal",
            pe_id: "1601100000000000354",
            template_id: "1107176310917693487", // 👈 parent SMS ka DLT template_id
            to: phone,
